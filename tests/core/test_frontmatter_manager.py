...
from mkdocs_note.utils.frontmatter.frontmatter_manager import (
    MetadataField,
    MetadataRegistry,
    FrontmatterParser,
    FrontmatterManager,
...
from mkdocs_note.utils.data_models import NoteFrontmatter
...
# Content"""
        ...
        updated_content = parser.update_frontmatter(original_content, updates, merge=True)
...
# Content"""
        ...
        updated_content = parser.update_frontmatter(original_content, updates, merge=False)
...
class TestGlobalRegistry:
    ...
    def test_register_field_global(self):
        ...
        initial_fields = len(get_registry().get_all_fields())
